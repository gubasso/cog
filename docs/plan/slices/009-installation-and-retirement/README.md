...
<!-- markdownlint-configure-file { "MD043": { "headings": ["# 009 — Installation and retirement","## Goal","## Appetite","## Core","## In scope","## Out of scope","## Governed by","## Acceptance","## Rabbit holes","## Done when","## Revisions"] } } -->
...
- `docs/decisions/0004-manifest-owned-installation.md` — install authority.
