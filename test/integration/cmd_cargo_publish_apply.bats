setup() {
  ...
  TEMPLATE_ROOT="${REPO_ROOT}/skill-refs/templates/cargo-publish"
}

@test "cog cargo-publish-apply copies scripts and PUBLISHING.md" {
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --json
...
@test "cog cargo-publish-apply lands PUBLISHING.md under docs/ when requested" {
  ...
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir docs --json
...
@test "cog cargo-publish-apply includes release-plz.toml with --with-release-plz" {
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --with-release-plz --json
...
@test "cog cargo-publish-apply includes dist-workspace.toml with --with-dist" {
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --with-dist --json
...
@test "cog cargo-publish-apply aborts on a pre-existing destination" {
  ...
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --conflict abort --json
...
@test "cog cargo-publish-apply skips existing destinations under --conflict skip" {
  mkdir -p "${BATS_TEST_TMPDIR}/repo/scripts"
  printf 'old\n' >"${BATS_TEST_TMPDIR}/repo/scripts/publish"
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --conflict skip --json
...
@test "cog cargo-publish-apply overwrites existing destinations under --conflict overwrite" {
  mkdir -p "${BATS_TEST_TMPDIR}/repo/scripts"
  printf 'old\n' >"${BATS_TEST_TMPDIR}/repo/scripts/publish"
  run cog cargo-publish-apply --project-root "${BATS_TEST_TMPDIR}/repo" --template-root "$TEMPLATE_ROOT" --doc-dir . --conflict overwrite --json
