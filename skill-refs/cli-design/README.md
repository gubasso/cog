...
- **Declare the facing category and message types.** Use [human-facing or machine-facing](./00-architecture.md#facing-category--message-types); keep human-UX, machine-output, and log-messages distinct.
