...
- 003 [linear-workflow-vertical](./slices/003-linear-workflow-vertical/README.md) — shaped — 3 sessions — first implementation slice; installs the workspace, the verb surface, and the validator
