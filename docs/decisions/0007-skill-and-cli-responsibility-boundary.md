...
<!-- markdownlint-configure-file { "MD043": { "headings": ["# ADR-0007: Separate skill judgment from CLI mechanics","## Context and Problem Statement","## Considered Options","## Decision Outcome","## Consequences","## Status"] } } -->
