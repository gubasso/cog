...
@test "codex-foreground blocks a Codex call with a sub-600000ms timeout" {
  run guard_fg '{"tool_name":"Bash","tool_input":{"command":"codex-session exec --profile low","timeout":120000}}'
...
@test "codex-foreground deny reason is legible on stderr" {
  run --separate-stderr guard_fg '{"tool_input":{"command":"codex-session exec","run_in_background":true,"timeout":600000}}'
