...
<!-- trigger-tests: "review-plan-claude", "review this plan before implementation", "validate one implementation plan" -->
...
- Do not retire `plan-reviewer`; that is separate follow-up work.
